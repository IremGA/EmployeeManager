...
public class ResilienceManager {
    ...
    public static final Logger Employee_Director_Logger = LoggerFactory.getLogger(ResilienceManager.class);
    ...
    public CircuitBreaker getCircuitBreaker(String uri){
        ...
        Employee_Director_Logger.debug("is reqeusted - best match - " + circuitName );
    ...
    public Retry getRetry(String uri){
        ...
        Employee_Director_Logger.debug("is reqeusted - best match - " + retryName );
